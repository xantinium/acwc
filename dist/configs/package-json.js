...
var PROJECT_NAME_REGEXP = /^[a-z\d\-]+$/;
var packageJSONPath = path_1.default.join(utils_1.PROCESS_DIR, 'package.json');
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, (0, utils_1.getFileContent)(packageJSONPath)];
                case 1:
...
function initPackageJSON() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, getPackageJSON()];
                case 1:
                    packageJSON = _b.sent();
                    ...
                    return [4, (0, utils_1.setFileContent)(packageJSONPath, JSON.stringify(packageJSON, null, 2))];
                case 2:
                    _b.sent();
                    return [2, packageJSON];
            }
