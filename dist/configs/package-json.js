...
var packageJSONPath = path.join(PROCESS_DIR, 'package.json');
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, getFileContent(packageJSONPath)];
                case 1:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, setFileContent(packageJSONPath, JSON.stringify(packageJSON, null, 2))];
                case 2:
                    _b.sent();
                    return [2 /*return*/, packageJSON];
            }
