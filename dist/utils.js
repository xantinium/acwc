...
var DIST_DIR = path_1.default.join(exports.CURRENT_DIR, '..', 'dist');
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, promises_1.default.mkdir(path_1.default.dirname(filepath), { recursive: true })];
                case 1:
                    _a.sent();
                    return [3, 3];
                case 2:
                    err_1 = _a.sent();
                    if (typeof err_1 === 'object' && err_1 !== null && 'code' in err_1 && err_1.code !== 'EEXIST') {
                        throw err_1;
                    }
                    return [3, 3];
                case 3: return [2, promises_1.default.writeFile(filepath, content + os_1.default.EOL, { encoding: 'utf-8' })];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, promises_1.default.mkdir(DIST_DIR)];
                case 1:
                    _a.sent();
                    return [3, 3];
                case 2:
                    err_2 = _a.sent();
                    if (typeof err_2 === 'object' && err_2 !== null && 'code' in err_2 && err_2.code !== 'EEXIST') {
                        throw err_2;
                    }
                    return [3, 3];
                case 3:
                    promises = Object.values(KNOWN_FILES).map(function (file) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, getFileContent(path_1.default.join(exports.CURRENT_DIR, '..', file.in))];
                                case 1:
                                    content = _a.sent();
                                    contentWithParams = fillAllParams(content, params);
                                    return [2, setFileContent(path_1.default.join(DIST_DIR, file.out), contentWithParams)];
                            }
                        });
                    }); });
